...
from usda_cn.utils.constants import MAJOR_WHEAT_STATES, STATE_NAMES_CN


logger = setup_logger("usda_cn.wheat")
...
class WheatData:
    ...
    示例:
        >>> wheat = WheatData(api_key="YOUR_KEY")
        >>> df = wheat.get_production(year=2024)
    """
    ...
    def __repr__(self) -> str:
        return f"WheatData(commodity='{self.COMMODITY_CN}')"
